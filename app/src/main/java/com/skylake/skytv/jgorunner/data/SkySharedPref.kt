...
class SkySharedPref(context: Context) {
    ...
    data class SharedPrefStructure(
        ...
        @SharedPrefKey("cloud_autoplay_first") var cloudAutoplayFirstChannel: Boolean = true,
        ...
        @SharedPrefKey("tata_play_portal_url") var tataPlayPortalUrl: String? = "http://localhost:8000/tataplay/",
        @SharedPrefKey("tata_play_playlist_url") var tataPlayPlaylistUrl: String? = "http://localhost:8000/tataplay/playlist.php",
        @SharedPrefKey("tata_play_setup_complete") var tataPlaySetupComplete: Boolean = false,
        @SharedPrefKey("tata_server_port") var tataServerPort: Int = 8000,
        @SharedPrefKey("tata_server_enabled") var tataServerEnabled: Boolean = true,
        @SharedPrefKey("tata_auto_update") var tataAutoUpdate: Boolean = true,
        @SharedPrefKey("tata_last_update_check") var tataLastUpdateCheck: Long = 0L,
        @SharedPrefKey("tata_bundle_etag") var tataBundleEtag: String? = null,
        @SharedPrefKey("tata_bundle_last_modified") var tataBundleLastModified: String? = null,
        @SharedPrefKey("tata_bundle_updated_at") var tataBundleUpdatedAt: Long = 0L,
